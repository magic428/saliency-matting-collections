#include "segmentation/EfficientGraphBased/segment-graph.h"
...
*/
int SegmentImage(cv::Mat &_src3f, Mat &pImgInd, double sigma, double c, int min_size)
{
...
#if 0
void SegmentImageDemo(std::string& inImgW, std::string& outDir, double sigma, double k, int min_size)
{
    vecS names;
    string inDir;
    CmFile::MkDir(outDir);
