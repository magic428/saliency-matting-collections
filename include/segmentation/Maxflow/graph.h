...
public:
    ...
    Graph(int node_num_max, int edge_num_max, void (*err_function)(const std::string &) = NULL);
...
private:
    ...
    void	(*error_function)(const std::string &);	// this function is called if a error occurs,
...
template <typename captype, typename tcaptype, typename flowtype> 
    Graph<captype, tcaptype, flowtype>::Graph(int node_num_max, int edge_num_max, void (*err_function)(const std::string &))
    : node_num(0),
      nodeptr_block(NULL),
